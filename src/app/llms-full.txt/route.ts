...
export async function GET(): Promise<Response> {
  ...
  return new Response(
    [
      ...
      `- [Pricing](${toPublicUrl("/pricing")}): Free community registry terms with no paid plans or SLA.`,
      `- [Pricing markdown](${toPublicUrl("/pricing.md")}): Machine-readable pricing notes.`,
      `- [Terms](${toPublicUrl("/terms")}): Public agent access, moderation, and versioning policy.`,
      `- [Terms markdown](${toPublicUrl("/terms.md")}): Machine-readable public use terms.`,
      ...
      `- [OAuth Protected Resource metadata](${toPublicUrl("/.well-known/oauth-protected-resource")}): Machine-readable public access metadata for the site.`,
      `- [OAuth Protected Resource MCP metadata](${toPublicUrl("/.well-known/oauth-protected-resource/mcp")}): Machine-readable public access metadata for the MCP endpoint.`,
      "",
      "## API reference",
      "",
      ...
      `- GET ${toPublicUrl("/.well-known/oauth-protected-resource/mcp")}: OAuth Protected Resource metadata for the public MCP endpoint.`,
      "",
      ...
      "",
      "- Codex Pets is a free community registry with no paid plans, invoices, quotas, or SLA.",
      "- Public APIs and MCP tools are best-effort.",
      "- Submissions and generation requests are moderated before public listing.",
      "- Current unversioned public endpoints are stable v1. Additive fields and new routes may be added without notice.",
      "- Breaking public-agent contract changes require a new path or a published deprecation notice.",
      "",
