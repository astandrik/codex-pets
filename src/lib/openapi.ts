    ...
    paths: {
      ...
      "/api/submissions/register": {
        post: {
          ...
          description:
            "Uploads pet.json, spritesheet.webp or spritesheet.png, and a ZIP containing both files at the root. Anonymous submissions with contactEmail must include publicAuthorName. contactEmail stays private unless publishContactEmail is true and a moderator verifies and publishes that address.",
          security: publicReadSecurity,
          parameters: [idempotencyKeyHeader],
          requestBody: {
            required: true,
        ...
        RegisterSubmissionForm: {
          ...
          properties: {
            ...
            publicAuthorName: {
              ...
              maxLength: 80,
              description:
                "Public alias required for anonymous submissions that provide contactEmail. Signed-in submissions always use the account profile name.",
            },
            publishContactEmail: {
              type: "boolean",
              default: false,
