...
import {
  ...
  RELATED_PETS_V23_RELATION_POLICY_REVISION,
...
describe("related-pets V23 relation policy", () => {
  it("adds the verified Primaris franchise without mutating V11 data", () => {
    const result = applyRelatedPetsRelationPolicy({
      slug: "primaris",
      annotation,
      revision: RELATED_PETS_V23_RELATION_POLICY_REVISION,
    });
  ...
  it("is a no-op for V11 and unrelated pets", () => {
