...
- Web manifest is generated by `src/app/manifest.ts`; branded 404 lives in `src/app/not-found.tsx`; `/favicon.ico` and brand PNG icons are generated from `public/favicon.svg` by `scripts/generate-brand-icons.mjs` (run it after changing the SVG).
